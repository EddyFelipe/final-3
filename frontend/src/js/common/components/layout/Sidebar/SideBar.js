            ...
            <aside className={`main-sidebar px-0 col-12 col-md-3 col-lg-2 ${toggleOpen?'':'open'}`}>
                ...
                <div className="nav-wrapper">
                    <ul className="nav--no-borders flex-column nav">
                        ...
                        <li className="nav-item">
                            <NavLink to="/tareas" className="nav-link" activeClassName={'active'}>
                                <div className="d-inline-block item-icon-wrapper">
                        ...
                        <li className="nav-item">
                            <NavLink to="/tatrabajada" className="nav-link" activeClassName={'active'}>
                                <div className="d-inline-block item-icon-wrapper">
                                    <i className="material-icons">vertical_split</i>
                                </div>
                                <span>Tareas Trabajadas</span>
                            </NavLink>
                        </li>
                        <li className="nav-item">
